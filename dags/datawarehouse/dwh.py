...
def staging_table():
    ...
    try:
        ...
        logger.error(f"Error in {schema} table process: {e}")
        raise e
...
def core_table():
    ...
    try:
        ...
        logger.info(f"{schema} table process completed successfully.")

    except Exception as e:
        logger.error(f"Error in core {schema} table process: {e}")   
        raise e
